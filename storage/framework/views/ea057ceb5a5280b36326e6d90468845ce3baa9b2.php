...
<body class="footer-offset pos-interface">
                        ...
                        <div class="row mb-2 category-slider">
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label for="category<?php echo e($item->id); ?>"
                                    ...
                                    <input class="d-none" id="category<?php echo e($item->id); ?>" type="radio"
                                        value="<?php echo e($item->id); ?>" name="category"
                            ...
                            <div class="col-12 col-sm-12 col-md-8 col-lg-9 px-1">
                                <form class="search-box">
                                    ...
                                    <input id="search" onkeyup="medicineSearch(this.value)" autocomplete="off"
                                        type="text" value="<?php echo e($keyword ? $keyword : ''); ?>" name="search"
                                ...
                                <div class="input-group float-right">
                                    <select name="vendor" id="vendor" class="form-control js-select2-custom mx-1"
                                        ...
                                        <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vdrItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($vdrItem->id); ?>"
                                                <?php echo e($vendor == $vdrItem->id ? 'selected' : ''); ?>><?php echo e($vdrItem->name); ?>
                                        ...
                                        <div class="d-flex align-items-center justify-content-end">
                                            ...
                                            <div class="dropdown user-profile-button">
                                                ...
                                                <div class="dropdown-menu"
                                                    ...
                                                    <a class="dropdown-item" href="<?php echo e(route('invoice.reports')); ?>">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                            value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(translate('name')); ?>"
                                            required>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-6">
                                ...
                                <div class="col-12 col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address" class="form-control"
                                            value="<?php echo e(old('address')); ?>" placeholder="<?php echo e(translate('address')); ?>"
                                            required>
                                    </div>
                                </div>
                            </div>
                ...
                $.post({
                    ...
                    success: function(data) {
                        ...
                        if (data.extra_discount === 'success') {
                            ...
                            toastr.warning(
                                '<?php echo e(translate('this_discount_is_not_applied_for_this_amount')); ?>', {
                                    CloseButton: true,
                                    ProgressBar: true
                                });
                        }
    ...
    <script>
        ...
        function removeFromCart(key) {
            //console.log(key);
            $.post('<?php echo e(route('pos.remove-from-cart')); ?>', {
                _token: '<?php echo e(csrf_token()); ?>',
                key: key
            }, function(data) {
        ...
        function emptyCart() {
            Swal.fire({
                ...
                if (result.value) {
                    $.post('<?php echo e(route('pos.emptyCart')); ?>', {
                        _token: '<?php echo e(csrf_token()); ?>'
                    }, function(data) {
                        $('#cart').empty().html(data.view);
                        toastr.info('Item has been removed from cart', {
            ...
            if (qty !== "") {
                ...
                $.post('<?php echo e(route('pos.updateQuantity')); ?>', {
                    ...
                    if (data.upQty === 'zeroNegative') {
                        toastr.warning(
                            '<?php echo e(translate('Product_quantity_can_not_be_zero_or_less_than_zero_in_cart!')); ?>', {
                                CloseButton: true,
                                ProgressBar: true
                            });
                    }
    ...
    <script>
        if (/MSIE \d|Trident.*rv:/.test(navigator.userAgent)) document.write(
            '<script src="<?php echo e(asset('pos')); ?>/vendor/babel-polyfill/polyfill.min.js"><\/script>');
    </script>
</body>

</html>
<?php /**PATH E:\xampp\htdocs\PHARMACY\resources\views/pos/index.blade.php ENDPATH**/ ?>