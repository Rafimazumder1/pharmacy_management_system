...
<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <?php else: ?>
            <form method="POST" action="<?php echo e(route('requisitions.updateApproval_appr2')); ?>">
                <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="approval_status[<?php echo e($requisition->id); ?>]" class="form-control approval-status">
                                        <option value="Y" <?php echo e($requisition->appr_2 == 'Y' ? 'selected' : ''); ?>>Yes</option>
                                        <option value="N" <?php echo e($requisition->appr_2 == 'N' ? 'selected' : ''); ?>>No</option>
                                        <option value="C" <?php echo e($requisition->appr_2 == 'C' ? 'selected' : ''); ?>>Cancel</option>
                                    </select>
                                </td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\PHARMACY\resources\views/requisitions/approval_appr2.blade.php ENDPATH**/ ?>