...
<html>
    <head> 
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('shop/style.css')); ?>" media="all">  
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('shop/assets/bootstrap-4.6.1/css/bootstrap.min.css')); ?>" media="all">
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('shop/assets/bootstrap-4.6.1/css/owl.carousel.min.css')); ?>" media="all">
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('shop/assets/bootstrap-4.6.1/css/owl.theme.default.min.css')); ?>" media="all">
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('shop/assets/fontawesome/css/all.min.css')); ?>" media="all">
        
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('shop/custom.css')); ?>" media="all">  
    ...
    <body>
            ...
            <div class="container">
                <div class="row align-items-center ">
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        <h6 class="top_title"><?php echo e($top_bar->title ?? ""); ?></h6>
                    </div>
                    <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                        <div class="site_info">
                            <div class="site_mobile d-flex align-items-center">
                                ...
                                <a href="tel:+88 <?php echo e($top_bar->phone ?? ""); ?>" class="text-white text-decoration-none">+88 <?php echo e($top_bar->phone ?? ""); ?></a>
                            </div>
                            <div class="site_email d-flex align-items-center">
                                <i class="fas fa-envelope top_icon"></i>
                                
                                <a href="mailto:<?php echo e($top_bar->email ?? ""); ?>" class="text-white text-decoration-none"><?php echo e($top_bar->email ?? ""); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-12 d-md-flex desktopmenu"> 
                            <div class="col-sm-12 col-md-4 col-lg-4 d-md-flex justify-content-md-start" id="menupart1">
                                <h3 class="logo"><a href="<?php echo e(route('shop.index', $shop->username)); ?>" class="logo"
                              ><?php echo e($shop->name); ?></a></h3>
                            </div>
                            <div class="col-sm-12 col-md-8 col-lg-8 d-md-flex menupart2 align-items-center" id="menupart2">
                                <!--search section-->
                                <div class="container searchfield">
                                    <form method="GET" action="<?php echo e(route('medicine.search', $shop->username)); ?>">
                                        <div class="input-group md-form form-sm form-2 pl-0 ">
                                            <input class="form-control my-0 py-1 red-border" type="text" value="<?php echo e(isset($query) ? $query : ''); ?>" placeholder="Search Your Medicine" aria-label="Search" name="query" required>
                                ...
                                <div class="col-sm-12 col-md-4 col-lg-4 justify-content-md-end btnm align-items-center">
                                    <div class="header_links">
                                        ...
                                        <!--</a>-->
                                        <a href="<?php echo e(route('shop.cart', $shop->username)); ?>" id="btnb">
                                            <div class="cart_wrap">
                                                 <i class="fa fa-shopping-cart cart_icon"></i>
                                                 <span class="cart_count"><?php if($carts->sum('qty') > 0 ): ?> <?php echo e($carts->sum('qty')); ?> <?php else: ?> 0 <?php endif; ?></span>
                                            </div>
                                    
                                            <div class="top_cart_total">৳ <?php echo e(number_format($total_price,2)?? 0.00); ?> </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="mobilemenu"> 
                            <div class="menupart1">
                                <div class="logom"><a href="index.html"><?php echo e($shop->name); ?></a></div>
                            ...
                            <div id="mySidepanel" class="sidepanel menupart2">
                                ...
                                <div id="menupart21">
                                    <ul>
                                        <li><a href="<?php echo e(route('shop.index', $shop->username)); ?>">Home</a></li>
                                        <li><a href="<?php echo e(route('about', $shop->username)); ?>">About Us</a></li>
                                        <li><a href="<?php echo e(route('product.all', $shop->username)); ?>">Medicines</a></li>
                                        <li><a href="<?php echo e(route('address', $shop->username)); ?>">Contact</a></li>
                                    </ul>
                                </div>
                                <div class="btnCart" >
                                    <a class"mobile_add_cart_btn" href="<?php echo e(route('shop.cart', $shop->username)); ?>"><i class="fa fa-shopping-cart"></i> Cart</a>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6 col-xs-6 pb-2 pr-2">
                            <div class="footer-text pull-left">
                                <div class="d-flex">
                                    <img src="<?php echo e(asset('shop/img/Logo.png')); ?> " width="250px">
                                </div>
        ...
        <script type="text/javascript" src="<?php echo e(asset('shop/assets/js/jquery.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('shop/assets/js/popper.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('shop/assets/bootstrap-4.6.1/js/bootstrap.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('shop/assets/fontawesome/js/all.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('shop/assets/bootstrap-4.6.1/js/owl.carousel.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('shop/custom.js')); ?>"></script>
...
</html><?php /**PATH E:\xampp\htdocs\PHARMACY\resources\views/layouts/shop.blade.php ENDPATH**/ ?>