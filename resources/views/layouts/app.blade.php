...
<link rel="stylesheet" type="text/css" href="{{ asset('dashboard/app-assets/css/pages/dashboard-ecommerce.css') }}?time={{ time() }}">
<link rel="stylesheet" type="text/css" href="{{ asset('dashboard/app-assets/css/plugins/charts/chart-apex.css') }}?time={{ time() }}">
...
<!-- Popper.js -->
<script type="text/javascript" src="{{ asset('dashboard/app-assets/morris-chart/popper.min.js') }}"></script>
