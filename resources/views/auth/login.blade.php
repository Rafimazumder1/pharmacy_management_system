                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5 ">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <p class="card-text mb-2 ">{{ __('Please sign-in to your account and manage your pharmacy.') }}</p>
                                ...
                                @enderror
                                    ...
                                    <button class="btn btn-dark w-100 text-black" tabindex="4">{{ __('Sign in') }}</button>
